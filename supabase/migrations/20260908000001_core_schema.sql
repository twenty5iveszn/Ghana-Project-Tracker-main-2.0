-- ==============================================================================
-- GHANABUILD 2.0 — CORE POSTGRESQL DATABASE SCHEMA
-- Migration: 20260908000001_core_schema.sql
-- Description: Core 17 entities, custom enums, foreign keys, indexes, and triggers.
-- ==============================================================================
...
-- 3. Utility Trigger for Automated updated_at Timestamps
...
-- ==============================================================================
-- 4. GEOGRAPHIC TAXONOMY TABLES (Ghana Regional Hierarchy)
-- ==============================================================================

-- 4.1 Regions Table (16 Regions of Ghana)
...
-- 4.2 Districts Table (261 MMDAs in Ghana)
CREATE TABLE IF NOT EXISTS districts (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    region_id UUID NOT NULL REFERENCES regions(id) ON DELETE RESTRICT,
    name VARCHAR(150) NOT NULL,
    district_type VARCHAR(50) NOT NULL DEFAULT 'DISTRICT', -- METROPOLITAN, MUNICIPAL, DISTRICT
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    CONSTRAINT uq_region_district_name UNIQUE (region_id, name)
);

-- 4.3 Communities Table
...
-- ==============================================================================
-- 5. ROLES & PROFILES (User & RBAC Architecture)
-- ==============================================================================

-- 5.1 Roles Reference Table
...
-- 5.2 User Profiles (Linked to Supabase auth.users)
...
-- ==============================================================================
-- 6. PROJECT CATEGORIES & CONTRACTORS
-- ==============================================================================

-- 6.1 Project Categories Table
...
-- ==============================================================================
-- 9. PROJECT EVIDENCE & DOCUMENTS
-- ==============================================================================

-- 9.1 Project Evidence (GPS-tagged photos, video, site inspections)
...
-- 9.2 Project Documents (Contracts, Budgets, Tenders, Completion Certs)
...
-- ==============================================================================
-- 10. COMMUNITY REPORTS & INCIDENTS
-- ==============================================================================
...
-- ==============================================================================
-- 11. COMMUNITY COMMENTS & ENGAGEMENT
-- ==============================================================================
...
-- ==============================================================================
-- 13. AUDITABLE VERIFICATION HISTORY
-- ==============================================================================
...
-- ==============================================================================
-- 14. IMMUTABLE AUDIT LOGS (Section 21 & 50)
-- ==============================================================================
...
-- ==============================================================================
-- 16. PERFORMANCE INDEXES (Section 42)
-- ==============================================================================
...
-- Auditing & Notifications Indexes
...
-- ==============================================================================
-- 17. AUTOMATED PROFILE SYNCHRONIZATION TRIGGER
-- Syncs auth.users signup with public.profiles table
-- ==============================================================================
